...
function LoginPage() {
  ...
  return (
    ...
    <>
      <label>
        Username:
        <input id='user-name-input' type="text" value={username} onChange={(e) => setUsername(e.target.value)} required/>
      </label>
      <br />
      <br />
      <label>
        Password:
        <input id='password-name-input' type="password" value={password} onChange={(e) => setPassword(e.target.value)} required/>
      </label>
      <br />
      ...
      {isAuthenticated === true && (
        ...
        <button style={buttonStyle} onClick={() => navigate('/create-content')}>Create Content </button>
        </>
      )}
    </div>
  );
